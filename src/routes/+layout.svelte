...
<svelte:head>
	...
	<link
		href="https://fonts.googleapis.com/css2?family=Nunito:wght@400;600;700;800;900&family=Plus+Jakarta+Sans:wght@400;500;700;800&family=Poppins:wght@600;700;800;900&display=swap"
		rel="stylesheet"
	/>
</svelte:head>
